...
FROM surnet/alpine-wkhtmltopdf:3.8-0.12.5-full 
...
RUN apk --no-cache add \
   php7@php php7-opcache@php php7-fpm@php php7-cgi@php php7-ctype@php php7-json@php php7-dom@php php7-zip@php php7-zip@php php7-gd@php \
   php7-curl@php php7-mbstring@php php7-redis@php php7-mcrypt@php php7-posix@php php7-pdo_mysql@php php7-tokenizer@php php7-simplexml@php php7-session@php \
   php7-xml@php php7-sockets@php php7-openssl@php php7-fileinfo@php php7-ldap@php php7-exif@php php7-pcntl@php php7-xmlwriter@php php7-phar@php php7-zlib@php \
   php7-intl@php php7-gmp@php
