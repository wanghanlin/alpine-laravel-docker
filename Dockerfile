...
RUN apk --no-cache add tzdata && \
 ...
 RUN apk --no-cache --repository=http://dl-cdn.alpinelinux.org/alpine/v3.13/community add \
    ...
    php7-intl php7-gmp php7-iconv php7-bcmath php7-xmlreader

RUN apk --no-cache --repository=http://dl-cdn.alpinelinux.org/alpine/v3.13/main add bash curl git openssh-client supervisor \
